...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (45768763,937694,21603834,21603823,2721577,21603845,2108678)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
...
JOIN #Codesets cs on (o.observation_concept_id = cs.concept_id and cs.codeset_id = 31)
) C
