$(document).ready(function(){
  Shiny.addCustomMessageHandler('jsondata_modality', function(message) {
    d3.sankey = function() {
      let sankey = {},
          nodeWidth = 24,
          nodePadding = 8,
    ...
    d3.select("#modalityChart").remove();
    const data = message;
    ...
    const svg = d3.select("#modalityPathwaysD3").append("svg")
        .attr("width", width + margin.left + margin.right)
        .attr("height", height + margin.top + margin.bottom)
        .attr("id", "modalityChart")
        .append("g")
        .attr("transform",
